...
* Zipf and Heaps now can be applied to character level studies. This is done with an argument, like it was previously done with information_theory functions.
