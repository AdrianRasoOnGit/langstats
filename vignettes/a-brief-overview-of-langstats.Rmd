...
In this document we present a short tour around the main functions and capabilities of `langstats` through a comprehensive set of given problems and use cases. We encourage the reader to follow the procedures, but we encourage even more to be creative and to find more interesting applications of the function. Here, we will only deal with plain and accessible cases, that guarantees a full grasp of how the package works.
